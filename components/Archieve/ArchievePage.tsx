          ...
          <View style={({height: 60,flexDirection: 'row'})}>
              <View style={({width: 60, alignItems: 'center', justifyContent: 'center'})}>
                  <View style={ArchieveStyle.profile}>
                      <Image style={({width: 50, height: 50, borderRadius: 100})} source={imagePath}></Image>
                  </View>
              </View>
              <View style={({width: 150, flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start'})}>
